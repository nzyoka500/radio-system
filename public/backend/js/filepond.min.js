...
// Site Logo Dark Pond
const siteLogoDark = document.querySelector('input[name=site_logo_dark]');
const siteLogoDarkPond = FilePond.create(siteLogoDark,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
...
// Site Favicon
const siteFavicon = document.querySelector('input[name=site_favicon]');
const siteFaviconPond = FilePond.create(siteFavicon,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
    imagePreviewHeight: 80,
    imageCropAspectRatio: '16:9',
...
// Site Favicon
const siteFaviconDark = document.querySelector('input[name=site_favicon_dark]');
const siteFaviconDarkPond = FilePond.create(siteFaviconDark,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
    imagePreviewHeight: 80,
    imageCropAspectRatio: '16:9',
    imageResizeTargetWidth: 80,
...
// Filepond-two
const filepondTwo = document.querySelector('input[name=filepond-two]');
const filepondTwokPond = FilePond.create(filepondTwo,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
    imagePreviewHeight: 80,
    imageCropAspectRatio: '16:9',
    imageResizeTargetWidth: 200,
...
const gatewayPond = FilePond.create(gateway,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
    imagePreviewHeight: 80,
    imageCropAspectRatio: '16:9',
...
// Gateway Pond
const gatewayTwo = document.querySelector('input[name=gateway-two]');
const gatewayTwoPond = FilePond.create(gatewayTwo,{
    labelIdle: `Drag & Drop Image or <span class="filepond--label-action">Browse</span>`,
    imagePreviewHeight: 80,
    imageCropAspectRatio: '16:9',
    imageResizeTargetWidth: 300,
