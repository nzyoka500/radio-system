        ...
        <div class="col-xl-12 col-lg-12 mb-10">
            <div class="custom-card">
                <div class="card-header">
                    <h5 class="title">@if(is_object($setup_page->title) && property_exists($setup_page->title, 'title'))
    {{ __($setup_page->title->title) }}
@elseif(is_string($setup_page->title))
    {{ __(json_decode($setup_page->title)->title) }}
@else
    {{ __('Default Title') }}
@endif {{ __("Page") }}</h5>
                </div>
